...
import { isTopSideMenuEnabled } from './menu/top-side-menu';
...
const mixedNavKeepSidebarLogo = computed(() => isTopSideMenuEnabled());

const logoTheme = computed(() => {
  if (showHeaderNav.value && !mixedNavKeepSidebarLogo.value) {
...
<template>
  <VbenAdminLayout
    ...
    :layout="layout"
    :mixed-nav-keep-sidebar-logo="mixedNavKeepSidebarLogo"
